    ...
    <div className="space-y-4 pb-2">
      ...
      <div className="rounded-2xl bg-rose-50 p-4 ring-1 ring-rose-100">
        ...
        <p className="mt-1 text-xs text-slate-600">
          Se borran todos tus gastos, precios, deudas, préstamos, ingresos y gastos extra, suscripciones, ajustes y tu PIN de este dispositivo. No se puede deshacer. Te recomendamos
